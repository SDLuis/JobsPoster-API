...
export const getJobsWithoutSensitiveInfo = (job: NotSensistiveInfoJobs[]): NotSensistiveInfoJobs[] => {
    return job.map(({ Jobs_ID, work_Title, Job_URL, workType, Position, apply_Method, description }) => {
        return {
